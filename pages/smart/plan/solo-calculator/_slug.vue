    ...
    <div class="product_page" :class="ToggleFooterZindex ? 'footer_zindex':''">
        ...
        <transition name="fade" v-if="show">
            <section class="calculator_main smart">
                ...
                <h2>{{ this.PlanType }} {{ PlanDetails.pl_name }}</h2>
                ...
                <div class="calculator_holder">
                    <div class="calculator_box downloadtime">
                        ...
                        <div class="calculator_meter">
                            ...
                            <div class="pointer_gold" :style="'transform: '+PointerTransform"></div>
                ...
                <div class="calculator_link">
                    ...
                    <nuxt-link :to="'/smart/plan/compare-options/'+PlanDetails.pl_id">
...
<style>
.calculator_main.smart .calculator_link button{
    width: 46%;
...
.calculator_main.smart .calculator_box .header, .calculator_main.smart .calculator_box .calculator_hours{
    background-image: linear-gradient(90deg, rgba(204,157,70,1) 0%, rgba(204,157,70,1) 35%, rgba(183,114,43,1) 100%);
}
.calculator_main.smart .calculator_slider_indi p, .calculator_main.smart .value{
    color: #eead38;
}
.slidecontainer{
    padding:10px;
...
export default {
  ...
  mounted() {
      // Plan Details
      this.$axios.$get('getSmartPlanID?pl_id='+this.PlanID).then( res => {
        if(res){
            this.show = true;
